...
> **⚠️ 此 ADR 部分内容需要更新(2026-07-16)**
> **本 ADR 核心结论仍然有效**(免费 Apple ID + iPhone 真机部署可行)
> **但工具链建议已变**:ADR-0008 推荐爱思助手 + SideStore(替代本 ADR 推荐的 AltServer / Sideloadly)
> **请参阅**: `docs/adr/0008-deployment-final-i4tools-sidestore.md` 终极方案

> **状态**: 🟡 **EFFECTIVE**(核心结论有效,工具链建议已更新到 ADR-0008)
> **日期**: 2026-07-14
> **修订**: 2026-07-16(工具链建议更新)
